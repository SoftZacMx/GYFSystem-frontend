        ...
        <div className="flex flex-col overflow-hidden p-4">
          <div className="relative mb-3">
            ...
            <input
              ...
              className="w-full rounded-xl border border-input bg-slate-50 py-2.5 pl-10 pr-4 text-slate-800 placeholder:text-slate-400 focus:outline-0 focus:ring-2 focus:ring-primary/30"
            />
          </div>
